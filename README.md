...
| Contextual Molecular<br/>Property Prediction |    Attributed    |  Predictive/Knowledge-based   |                             None                             |                          CE                           |       P\&F        | 2020 |
| Graph-level Motif Prediction                 |    Attributed    |  Predictive/Knowledge-based   |                             None                             |                          CE                           |       P\&F        | 2020 |
...
| GMI                                          |    Node/Link    | Node Classification<br/>(Acc, Micro-F1)<br/>Link Prediction (ROC-AUC) |   Cora, Citeseer, PubMed, Reddit, PPI, BlogCatalog, Flickr   |
